...
function nel_render_main_panel()
{
    ...
    nel_render_general_header($render, null, null, array('header' => 'MANAGE_GENERAL', 'sub_header' => 'MANAGE_OPTIONS'));
...
function nel_render_main_board_panel($board_id)
{
    ...
    $render->startRenderTimer();
    $render->getTemplateInstance()->setTemplatePath(TEMPLATE_PATH);
    nel_render_general_header($render, null, $board_id, array('header' => 'MANAGE_BOARD', 'sub_header' => 'MANAGE_OPTIONS'));
    $dom = $render->newDOMDocument();
