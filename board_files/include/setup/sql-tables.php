...
function nel_insert_config_defaults()
{
    ...
    $result = $dbh->query("INSERT INTO " . CONFIG_TABLE . " (config_type, config_owner, config_category, data_type, config_name, setting)
                VALUES  ('technical', 'nelliel', 'database', 'str', 'original_schema_version', '003'),
                        ...
                        ('board_setting', 'nelliel', 'general', 'bool', 'force_anonymous', ''),
                        ('board_setting', 'nelliel', 'general', 'bool', 'show_title', '1'),
                        ('board_setting', 'nelliel', 'general', 'bool', 'show_favicon', ''),
                        ('board_setting', 'nelliel', 'general', 'bool', 'show_logo', ''),
                        ('board_setting', 'nelliel', 'general', 'bool', 'use_thumb', '1'),
                        ('board_setting', 'nelliel', 'general', 'bool', 'use_magick', ''),
                        ('board_setting', 'nelliel', 'general', 'bool', 'use_file_icon', '1'),
                        ('board_setting', 'nelliel', 'general', 'bool', 'use_png_thumb', ''),
                        ('board_setting', 'nelliel', 'general', 'bool', 'require_image_start', '1'),
                        ('board_setting', 'nelliel', 'general', 'bool', 'require_image_always', ''),
                        ('board_setting', 'nelliel', 'general', 'bool', 'allow_multifile', ''),
                        ('board_setting', 'nelliel', 'general', 'bool', 'allow_op_multifile', ''),
                        ...
                        ('board_setting', 'nelliel', 'general', 'int', 'max_comment_length', '1000'),
                        ...
                        ('filetype_enable', 'nelliel', 'graphics', 'bool', 'tiff', ''),
                        ('filetype_enable', 'nelliel', 'graphics', 'bool', 'bmp', '1'),
                        ('filetype_enable', 'nelliel', 'graphics', 'bool', 'ico', ''),
                        ('filetype_enable', 'nelliel', 'graphics', 'bool', 'psd', ''),
                        ('filetype_enable', 'nelliel', 'graphics', 'bool', 'tga', ''),
                        ('filetype_enable', 'nelliel', 'graphics', 'bool', 'pict', ''),
                        ('filetype_enable', 'nelliel', 'graphics', 'bool', 'art', ''),
                        ('filetype_enable', 'nelliel', 'audio', 'bool', 'audio', ''),
                        ('filetype_enable', 'nelliel', 'audio', 'bool', 'wav', ''),
                        ('filetype_enable', 'nelliel', 'audio', 'bool', 'aiff', ''),
                        ('filetype_enable', 'nelliel', 'audio', 'bool', 'mp3', ''),
                        ('filetype_enable', 'nelliel', 'audio', 'bool', 'm4a', ''),
                        ('filetype_enable', 'nelliel', 'audio', 'bool', 'flac', ''),
                        ('filetype_enable', 'nelliel', 'audio', 'bool', 'aac', ''),
                        ('filetype_enable', 'nelliel', 'audio', 'bool', 'ogg', ''),
                        ('filetype_enable', 'nelliel', 'audio', 'bool', 'au', ''),
                        ('filetype_enable', 'nelliel', 'audio', 'bool', 'wma', ''),
                        ('filetype_enable', 'nelliel', 'audio', 'bool', 'midi', ''),
                        ('filetype_enable', 'nelliel', 'audio', 'bool', 'ac3', ''),
                        ('filetype_enable', 'nelliel', 'video', 'bool', 'video', ''),
                        ('filetype_enable', 'nelliel', 'video', 'bool', 'mpeg', ''),
                        ('filetype_enable', 'nelliel', 'video', 'bool', 'mov', ''),
                        ('filetype_enable', 'nelliel', 'video', 'bool', 'avi', ''),
                        ('filetype_enable', 'nelliel', 'video', 'bool', 'wmv', ''),
                        ('filetype_enable', 'nelliel', 'video', 'bool', 'mp4', ''),
                        ('filetype_enable', 'nelliel', 'video', 'bool', 'mkv', ''),
                        ('filetype_enable', 'nelliel', 'video', 'bool', 'flv', ''),
                        ('filetype_enable', 'nelliel', 'document', 'bool', 'document', ''),
                        ('filetype_enable', 'nelliel', 'document', 'bool', 'rtf', ''),
                        ('filetype_enable', 'nelliel', 'document', 'bool', 'pdf', ''),
                        ('filetype_enable', 'nelliel', 'document', 'bool', 'doc', ''),
                        ('filetype_enable', 'nelliel', 'document', 'bool', 'ppt', ''),
                        ('filetype_enable', 'nelliel', 'document', 'bool', 'xls', ''),
                        ('filetype_enable', 'nelliel', 'document', 'bool', 'txt', ''),
                        ('filetype_enable', 'nelliel', 'archive', 'bool', 'archive', ''),
                        ('filetype_enable', 'nelliel', 'archive', 'bool', 'gzip', ''),
                        ('filetype_enable', 'nelliel', 'archive', 'bool', 'bz2', ''),
                        ('filetype_enable', 'nelliel', 'archive', 'bool', 'hqx', ''),
                        ('filetype_enable', 'nelliel', 'archive', 'bool', 'lzh', ''),
                        ('filetype_enable', 'nelliel', 'archive', 'bool', 'zip', ''),
                        ('filetype_enable', 'nelliel', 'archive', 'bool', 'rar', ''),
                        ('filetype_enable', 'nelliel', 'archive', 'bool', 'sit', ''),
                        ('filetype_enable', 'nelliel', 'archive', 'bool', 'tar', ''),
                        ('filetype_enable', 'nelliel', 'archive', 'bool', '7z', ''),
                        ('filetype_enable', 'nelliel', 'archive', 'bool', 'iso', ''),
                        ('filetype_enable', 'nelliel', 'archive', 'bool', 'dmg', ''),
                        ('filetype_enable', 'nelliel', 'other', 'bool', 'other', '1'),
                        ('filetype_enable', 'nelliel', 'other', 'bool', 'swf', '1'),
                        ('filetype_enable', 'nelliel', 'other', 'bool', 'blorb', '')
                        ");
