...
class TableInsertData
{
    ...
    public function permissionsDefaults()
    {
        ...
        $dbh->executePrepared($prepared, ['SUPER_ADMIN', 'perm_post_modmode', 1]);
        ...
        $dbh->executePrepared($prepared, ['BOARD_ADMIN', 'perm_post_modmode', 1]);
        ...
        $dbh->executePrepared($prepared, ['MOD', 'perm_post_modmode', 1]);
        ...
        $dbh->executePrepared($prepared, ['JANITOR', 'perm_post_modmode', 0]);
