...
function nel_staff_panel($section, $action)
{
    ...
    {
        nel_derp(340, nel_stext('You are not allowed to access the staff panel.'));
    }
    ...
    else if ($section === 'user')
    {
        ...
        if ($action === 'new')
        {
            ...
            {
                nel_derp(341, nel_stext('You are not allowed to modify staff.'));
            }
        ...
        {
            nel_derp(440, nel_stext('The specified user does not exist.'));
        }
    ...
    else if ($section === 'role')
    {
        ...
        {
            nel_derp(342, nel_stext('You are not allowed to modify roles.'));
        }
        ...
        {
            nel_derp(441, nel_stext('The specified role does not exist.'));
        }
    ...
    {
        nel_derp(442, nel_stext('No valid action given for user or role panels.'));
    }
}