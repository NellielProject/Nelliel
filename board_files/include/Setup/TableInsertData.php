...
class TableInsertData
{
    ...
    public function filetypes()
    {
        ...
        " (extension, parent_extension, type, format, mime, id_regex, label, description) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
        $prepared = $database->prepare($insert_query);
        $database->executePrepared($prepared, ['', null, 'graphics', null, null, null, 'Graphics files', null]);
        $database->executePrepared($prepared, ['jpg', 'jpg', 'graphics', 'jpeg', 'image/jpeg', '^\xFF\xD8\xFF', 'JPEG', '']);
        $database->executePrepared($prepared, ['jpeg', 'jpg', null, null, null, null, null, null]);
        $database->executePrepared($prepared, ['jpe', 'jpg', null, null, null, null, null, null]);
        ...
        $database->executePrepared($prepared, ['j2k', 'jp2', null, null, null, null, null, null]);
        $database->executePrepared($prepared, ['tiff', 'tiff', 'graphics', 'tiff', 'image/tiff', '^I\x20?I\x2A\x00|^MM\x00[\x2A-\x2B]', 'TIFF', '']);
        $database->executePrepared($prepared, ['tif', 'tiff', null, null, null, null, null, null]);
        ...
        $database->executePrepared($prepared, ['aiff', 'aif', null, null, null, null, null, null]);
        ...
        $database->executePrepared($prepared, ['snd', 'au', null, null, null, null, null, null]);
        ...
        $database->executePrepared($prepared, ['mid', 'midi', null, null, null, null, null, null]);
        $database->executePrepared($prepared, ['', null, 'video', null, null, null, 'Video files', null]);
        $database->executePrepared($prepared, ['mpg', 'mpg', 'video', 'mpeg', 'video/mpeg', '^\x00\x00\x01[\xB0-\xBF]', 'MPEG-1/MPEG-2', '']);
        $database->executePrepared($prepared, ['mpeg', 'mpg', null, null, null, null, null, null]);
        $database->executePrepared($prepared, ['mpe', 'mpg', null, null, null, null, null, null]);
        ...
        $database->executePrepared($prepared, ['gzip', 'gz', null, null, null, null, null, null]);
        $database->executePrepared($prepared, ['bz2', 'bz2', 'archive', 'bzip2', 'application/x-bzip2', '^BZh.{1}\x31\x41\x59\x26\x53\x59', 'bzip2', '']);
        $database->executePrepared($prepared, ['tbz2', 'bz2', null, null, null, null, null, null]);
        $database->executePrepared($prepared, ['tbz', 'bz2', null, null, null, null, null, null]);
        ...
        $database->executePrepared($prepared, ['lha', 'lzh', null, null, null, null, null, null]);
        ...
        $database->executePrepared($prepared, ['sitx', 'sit', null, null, null, null, null, null]);
        ...
        $database->executePrepared($prepared, ['glb', 'blorb', null, null, null, null, null, null]);
        $database->executePrepared($prepared, ['zblorb', 'blorb', null, null, null, null, null, null]);
        $database->executePrepared($prepared, ['zlb', 'blorb', null, null, null, null, null, null]);
        $database->executePrepared($prepared, ['tbz', 'bz2', null, null, null, null, null, null]);
        $database->executePrepared($prepared, ['tbz', 'bz2', null, null, null, null, null, null]);
        nel_setup_stuff_done(true);
    }
