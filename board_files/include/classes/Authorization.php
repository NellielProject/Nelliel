...
class Authorization
{
    ...
    public function getUser($user_id)
    {
        ...
        $this->users[$user_id] = new \Nelliel\AuthUser($this->dbh, $user_id);
    ...
    public function getRole($role_id)
    {
        ...
        $this->roles[$role_id] = new \Nelliel\AuthRole($this->dbh, $role_id);
    ...
    /*public function userHighestLevelRole($user_id, $board_id = '')
     ...
     foreach ($this->user_roles[$user_id] as $role)
     {
     $level = $this->roles[$role['role_id']]->auth_data['role_level'];
     ...
     if ($level > $role_level)
     {
     $role_level = $this->roles[$role['role_id']]->auth_data['role_level'];
     $role = $role['role_id'];
     }
     }
