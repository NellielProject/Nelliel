...
class ThreadHandler
{
    ...
    public function verifyDeletePerms($post_id)
    {
        ...
        {
            nel_derp(30, nel_stext('Id of thread or post was non-numeric. How did you even do that?'));
        }
        ...
        if (!$flag)
        {
            nel_derp(31, nel_stext('Password is wrong or you are not allowed to delete that.'));
        }
