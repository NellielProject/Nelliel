...
class BanHammer
{
    ...
    {
        if (!$this->authorize->get_user_perm($_SESSION['username'], 'perm_ban_add', BOARD_ID) &&
    ...
    {
        if (!$this->authorize->get_user_perm($_SESSION['username'], 'perm_ban_modify', BOARD_ID) &&
             !$authorize->get_user_perm($_SESSION['username'], 'perm_all_ban_modify'))
        {
    ...
    {
        if (!$this->authorize->get_user_perm($_SESSION['username'], 'perm_ban_delete', BOARD_ID) &&
