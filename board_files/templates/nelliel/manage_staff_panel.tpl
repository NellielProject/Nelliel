{{ if $rendervar['edit_staff'] }}
    ...
    {{ endif }}
            ...
            <tr>
                <td>
                    <input type="checkbox" name="perm_config" id="pconfig" value=1 {$rendervar['perm_config']}><label for="pconfig">{nel_stext('MANAGE_STAFF_ACC_SET')}</label>
                </td>
            </tr>
            <tr>
                <td>
                    <input type="checkbox" name="perm_staff_panel" id="bstaff" value=1 {$rendervar['perm_staff_panel']}><label for="bstaff">{nel_stext('MANAGE_STAFF_ACC_STAFF')}</label>
                </td>
            </tr>
            <tr>
                <td>
                    <input type="checkbox" name="perm_ban_panel" id="bpanel" value=1 {$rendervar['perm_ban_panel']}><label for="bpanel">{nel_stext('MANAGE_STAFF_ACC_BAN')}</label>
                </td>
            </tr>
            <tr>
                <td>
                    <input type="checkbox" name="perm_thread_panel" id="pthread" value=1 {$rendervar['perm_thread_panel']}><label for="pthread">{nel_stext('MANAGE_STAFF_ACC_THREAD')}</label>
                </td>
            </tr>
            <tr>
                <td>
                    <input type="checkbox" name="perm_mod_mode" id="pmode" value=1 {$rendervar['perm_mod_mode']}><label for="pmode">{nel_stext('MANAGE_STAFF_ACC_MMODE')}</label>
                </td>
            </tr>
            <tr>
                <td>
                    <input type="checkbox" name="perm_ban" id="pban" value=1 {$rendervar['perm_ban']}><label for="pban">{nel_stext('MANAGE_STAFF_PERMBAN')}</label>
                </td>
            </tr>
            <tr>
                <td>
                    <input type="checkbox" name="perm_delete" id="pdelete" value=1 {$rendervar['perm_delete']}><label for="pdelete">{nel_stext('MANAGE_STAFF_PERMDEL')}</label>
                </td>
            </tr>
            <tr>
                <td>
                    <input type="checkbox" name="perm_post" id="ppost" value=1 {$rendervar['perm_post']}><label for="ppost">{nel_stext('MANAGE_STAFF_PERMPOST')}</label>
                </td>
            </tr>
            <tr>
                <td>
                    <input type="checkbox" name="perm_post_anon" id="ppostanon" value=1 {$rendervar['perm_post_anon']}><label for="ppostanon">{nel_stext('MANAGE_STAFF_PERMANON')}</label>
                </td>
            </tr>
            <tr>
                <td>
                    <input type="checkbox" name="perm_sticky" id="psticky" value=1 {$rendervar['perm_sticky']}><label for="psticky">{nel_stext('MANAGE_STAFF_PERMSTICK')}</label>
                </td>
            </tr>
            <tr>
                <td>
                    <input type="checkbox" name="perm_update_pages" id="ppages" value=1 {$rendervar['perm_update_pages']}><label for="ppages">{nel_stext('MANAGE_STAFF_PERMGEN')}</label>
                </td>
            </tr>
            <tr>
                <td>
                    <input type="checkbox" name="perm_update_cache" id="pcache" value=1 {$rendervar['perm_update_cache']}><label for="pcache">{nel_stext('MANAGE_STAFF_PERMCACHE')}</label>
                </td>
            </tr>
            <tr>
                <td>
