...
<div class="float-left">
    <div>You have been banned from <span class="ban-bold">{$rendervar['board']}</span>. This ban was given on <span class="ban-bold">{$rendervar['format_time']}</span><br><br></div>
        <table>
            <tr><td>Reason for your ban: </td><td class="ban-bold">{$rendervar['reason']}</td></tr>
            <tr><td>Ban will expire: </td><td class="ban-bold">{$rendervar['format_length']}</td></tr>
            <tr><td>The banned IP or hostname is: </td><td class="ban-bold">{$rendervar['host']}</td></tr>
        <tr><td>The name used was: </td><td class="ban-bold">{$rendervar['name']}</td></tr>
        </table>
    </div>
