<div class="float-right"></div>
    <div class="float-left">
        <div>
            You have been banned from <span class="ban-bold">{$rendervar['board']}</span>. This ban was given on <span class="ban-bold">{$rendervar['format_time']}</span><br><br>
        </div>
        <table>
            <tr>
                <td>
