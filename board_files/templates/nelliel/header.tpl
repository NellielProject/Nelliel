...
<body>
    <div class="text-center">{S_SHORT_MENU}</div>
    <div>
        <span class="top_styles"> Styles: [<a href="#" onclick="changeCSS('Nelliel','style-{CONF_BOARD_DIR}'); return false;">Nelliel</a>]
            [<a href="#" onclick="changeCSS('Futaba','style-{CONF_BOARD_DIR}'); return false;">Futaba</a>] [<a href="#"
        ...
        </span> <span class="admin-bar"> {$rendervar['log_out']} [<a href="{$rendervar['dotdot']}{HOME}" rel="home">{LANG_LINK_HOME}</a>] [<a
            href="{$rendervar['dotdot']}{PHP_SELF}?mode=admin">{LANG_LINK_MANAGE}</a>] [<a href="{$rendervar['dotdot']}{PHP_SELF}?mode=about">{LANG_LINK_ABOUT}</a>]
        </span>
    </div>

    <div class="logo">{$rendervar['titlepart']}</div>
