{{ if $render->retrieve_data('main_page') }}
            <table>
                <tr>
                    <td>
                        {$render->retrieve_data('prev_nav')}</td><td>{$render->retrieve_data('page_nav')}</td><td>{$render->retrieve_data('next_nav')}
                    </td>
                </tr>
            </table>
{{ endif }}
{{ if $render->retrieve_data('del') }}
            <div class="clear"></div>
        </div>
    ...
    {{ if $render->retrieve_data('response') }}
        </div>
    {{ endif }}
    </form>
{{ endif }}
{{ if $render->retrieve_data('styles_link') }}
