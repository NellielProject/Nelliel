    ...
    <form accept-charset="utf-8" action="imgboard.php" method="post" enctype="multipart/form-data">
        <table>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="role_id" id="role_id" size="50" value="{$render->get('role_id')}">
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input type="text" name="role_level" id="role_level" size="5" value="{$render->get('role_level')}">
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input type="text" name="role_title" id="rtitle" size="50" value="{$render->get('role_title')}">
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input type="text" name="capcode_text" id="capcode_text" size="50" value="{$render->get('capcode_text')}">
                </td>
            </tr>
            <tr>
                <td>
                	<input type="hidden" name="perm_config_access" value=0>
                    <input type="checkbox" name="perm_config_access" id="perm_config_access" value=1 {$render->get('perm_config_access')}>
            ...
            <tr>
                <td>
                    ...
                    <input type="checkbox" name="perm_config_change" id="perm_config_change" value=1 {$render->get('perm_config_change')}>
            ...
            <tr>
                <td>
                    ...
                    <input type="checkbox" name="perm_user_access" id="perm_user_access" value=1 {$render->get('perm_user_access')}>
            ...
            <tr>
                <td>
                    ...
                    <input type="checkbox" name="perm_user_add" id="perm_user_add" value=1 {$render->get('perm_user_add')}>
            ...
            <tr>
                <td>
                    ...
                    <input type="checkbox" name="perm_user_modify" id="perm_user_modify" value=1 {$render->get('perm_user_modify')}>
            ...
            <tr>
                <td>
                    ...
                    <input type="checkbox" name="perm_user_delete" id="perm_user_delete" value=1 {$render->get('perm_user_delete')}>
            ...
            <tr>
                <td>
                    ...
                    <input type="checkbox" name="perm_user_change_pass" id="perm_user_change_pass" value=1 {$render->get('perm_user_change_pass')}>
            ...
            <tr>
                <td>
                    ...
                    <input type="checkbox" name="perm_role_access" id="perm_role_access" value=1 {$render->get('perm_role_access')}>
            ...
            <tr>
                <td>
                    ...
                    <input type="checkbox" name="perm_role_add" id="perm_role_add" value=1 {$render->get('perm_role_add')}>
            ...
            <tr>
                <td>
                    ...
                    <input type="checkbox" name="perm_role_modify" id="perm_role_modify" value=1 {$render->get('perm_role_modify')}>
            ...
            <tr>
                <td>
                    ...
                    <input type="checkbox" name="perm_role_delete" id="perm_role_delete" value=1 {$render->get('perm_role_delete')}>
            ...
            <tr>
                <td>
                    ...
                    <input type="checkbox" name="perm_ban_access" id="perm_ban_access" value=1 {$render->get('perm_ban_access')}>
            ...
            <tr>
                <td>
                    ...
                    <input type="checkbox" name="perm_ban_add" id="perm_ban_add" value=1 {$render->get('perm_ban_add')}>
            ...
            <tr>
                <td>
                    ...
                    <input type="checkbox" name="perm_ban_modify" id="perm_ban_modify" value=1 {$render->get('perm_ban_modify')}>
            ...
            <tr>
                <td>
                    ...
                    <input type="checkbox" name="perm_ban_delete" id="perm_ban_delete" value=1 {$render->get('perm_ban_delete')}>
            ...
            <tr>
                <td>
                    ...
                    <input type="checkbox" name="perm_post_access" id="perm_post_access" value=1 {$render->get('perm_post_access')}>
            ...
            <tr>
                <td>
                    ...
                    <input type="checkbox" name="perm_post_modify" id="perm_post_modify" value=1 {$render->get('perm_post_modify')}>
            ...
            <tr>
                <td>
                    ...
                    <input type="checkbox" name="perm_post_delete" id="perm_post_delete" value=1 {$render->get('perm_post_delete')}>
            ...
            <tr>
                <td>
                    ...
                    <input type="checkbox" name="perm_post_file_delete" id="perm_post_file_delete" value=1 {$render->get('perm_post_file_delete')}>
            ...
            <tr>
                <td>
                    ...
                    <input type="checkbox" name="perm_post_default_name" id="perm_post_default_name" value=1 {$render->get('perm_post_default_name')}>
            ...
            <tr>
                <td>
                    ...
                    <input type="checkbox" name="perm_post_custom_name" id="perm_post_custom_name" value=1 {$render->get('perm_post_custom_name')}>
            ...
            <tr>
                <td>
                    ...
                    <input type="checkbox" name="perm_post_override_anon" id="perm_post_override_anon" value=1 {$render->get('perm_post_override_anon')}>
            ...
            <tr>
                <td>
                    ...
                    <input type="checkbox" name="perm_post_sticky" id="perm_post_sticky" value=1 {$render->get('perm_post_sticky')}>
            ...
            <tr>
                <td>
                    ...
                    <input type="checkbox" name="perm_post_unsticky" id="perm_post_unsticky" value=1 {$render->get('perm_post_unsticky')}>
            ...
            <tr>
                <td>
                    ...
                    <input type="checkbox" name="perm_post_lock" id="perm_post_lock" value=1 {$render->get('perm_post_lock')}>
            ...
            <tr>
                <td>
                    ...
                    <input type="checkbox" name="perm_post_unlock" id="perm_post_unlock" value=1 {$render->get('perm_post_unlock')}>
            ...
            <tr>
                <td>
                    ...
                    <input type="checkbox" name="perm_post_in_locked" id="perm_post_in_locked" value=1 {$render->get('perm_post_in_locked')}>
            ...
            <tr>
                <td>
                    ...
                    <input type="checkbox" name="perm_post_comment" id="perm_post_comment" value=1 {$render->get('perm_post_comment')}>
            ...
            <tr>
                <td>
                    ...
                    <input type="checkbox" name="perm_post_permsage" id="perm_post_permsage" value=1 {$render->get('perm_post_permsage')}>
            ...
            <tr>
                <td>
                    ...
                    <input type="checkbox" name="perm_regen_caches" id="perm_regen_caches" value=1 {$render->get('perm_regen_caches')}>
            ...
            <tr>
                <td>
                    ...
                    <input type="checkbox" name="perm_regen_index" id="perm_regen_index" value=1 {$render->get('perm_regen_index')}>
            ...
            <tr>
                <td>
                    ...
                    <input type="checkbox" name="perm_regen_threads" id="perm_regen_threads" value=1 {$render->get('perm_regen_threads')}>
            ...
            <tr>
                <td>
                    ...
                    <input type="checkbox" name="perm_modmode_access" id="perm_modmode_access" value=1 {$render->get('perm_modmode_access')}>
            ...
            <tr>
                <td>
                    ...
                    <input type="checkbox" name="perm_modmode_view_ips" id="perm_modmode_view_ips" value=1 {$render->get('perm_modmode_view_ips')}>
