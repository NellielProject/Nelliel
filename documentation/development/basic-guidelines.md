...
## AI Code
AI code is fully banned from the Nelliel Project. Nothing in core, official plugins or official documentation can be generated by AI.

Why? Current code generation AI raises issues with copyright and open source licenses with no practical method of vetting the original context. There are unresolved ethical issues with the training of AI coding models. The enthusiasts pushing it have not presented themselves well. Until all of this is reasonably resolved, it's just not happening.