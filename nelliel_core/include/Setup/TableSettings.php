...
class TableSettings extends TableHandler
{
    ...
    public function insertDefaults()
    {
        ...
        $this->insertDefaultRow(['core', 'nelliel', 'string', 'recaptcha_type', '{"CHECKBOX":{"label":"Checkbox"}}', 'CHECKBOX', '', '', '{"type":"radio"}']);
        ...
        $this->insertDefaultRow(['core', 'nelliel', 'string', 'graphics_handler', '{"GD":{"label":"GD"}, "ImageMagick":{"label":"ImageMagick"}, "GraphicsMagick":{"label":"GraphicsMagick"}}', 'GD', '', '', '{"type":"radio"}']);
        ...
        $this->insertDefaultRow(['board', 'nelliel', 'boolean', 'show_name', '', '1', '', '', '{"type":"checkbox"}']);
        $this->insertDefaultRow(['board', 'nelliel', 'boolean', 'show_slogan', '', '1', '', '', '{"type":"checkbox"}']);
        $this->insertDefaultRow(['board', 'nelliel', 'boolean', 'show_favicon', '', '0', '', '', '{"type":"checkbox"}']);
        $this->insertDefaultRow(['board', 'nelliel', 'boolean', 'show_banner', '', '0', '', '', '{"type":"checkbox"}']);
        ...
        $this->insertDefaultRow(['board', 'nelliel', 'boolean', 'require_content_start', '', '1', '', '', '{"type":"checkbox"}']);
        $this->insertDefaultRow(['board', 'nelliel', 'boolean', 'require_content_always', '', '0', '', '', '{"type":"checkbox"}']);
        ...
        $this->insertDefaultRow(['board', 'nelliel', 'string', 'name', '', '', '', '', '{"type":"text"}']);
        $this->insertDefaultRow(['board', 'nelliel', 'string', 'slogan', '', '', '', '', '{"type":"text"}']);
        $this->insertDefaultRow(['board', 'nelliel', 'string', 'description', '', '', '', '', '{"type":"text"}']);
        $this->insertDefaultRow(['board', 'nelliel', 'string', 'favicon', '', '', '', '', '{"type":"text"}']);
        $this->insertDefaultRow(['board', 'nelliel', 'string', 'banner', '', '', '', '', '{"type":"text"}']);
        $this->insertDefaultRow(['board', 'nelliel', 'string', 'locale', '', 'en_US', '', '', '{"type":"text"}']);
        ...
        $this->insertDefaultRow(['board', 'nelliel', 'integer', 'abbreviate_thread', '', '5', '', '', '{"type":"number"}']);
        ...
        $this->insertDefaultRow(['board', 'nelliel', 'integer', 'threads_per_page', '', '10', '', '', '{"type":"number"}']);
        $this->insertDefaultRow(['board', 'nelliel', 'integer', 'page_limit', '', '10', '', '', '{"type":"number"}']);
        $this->insertDefaultRow(['board', 'nelliel', 'integer', 'thread_buffer', '', '100', '', '', '{"type":"number"}']);
        $this->insertDefaultRow(['board', 'nelliel', 'integer', 'max_posts', '', '1000', '', '', '{"type":"number"}']);
        $this->insertDefaultRow(['board', 'nelliel', 'integer', 'max_bumps', '', '1000', '', '', '{"type":"number"}']);
        $this->insertDefaultRow(['board', 'nelliel', 'string', 'tripkey_marker', '', '!', '', '', '{"type":"text"}']);
        $this->insertDefaultRow(['board', 'nelliel', 'string', 'date_format', '', 'Y/m/d (D) H:i:s', '', '', '{"type":"text"}']);
        ...
        $this->insertDefaultRow(['board', 'nelliel', 'boolean', 'do_archive_pruning', '', '1', '', '', '{"type":"checkbox"}']);
        $this->insertDefaultRow(['board', 'nelliel', 'integer', 'max_archive_threads', '', '500', '', '', '{"type":"number"}']);
        $this->insertDefaultRow(['board', 'nelliel', 'string', 'fgsfds_name', '', 'FGSFDS', '', '', '{"type":"text"}']);
        ...
        $this->insertDefaultRow(['board', 'nelliel', 'boolean', 'enable_dynamic_pages', '', '0', '', '', '{"type":"checkbox"}']);
        $this->insertDefaultRow(['board', 'nelliel', 'string', 'template_id', '', 'template-nelliel-basic', '', '', '{"type":"text"}']);
        $this->insertDefaultRow(['board', 'nelliel', 'string', 'icon_set_id', '', 'icons-nelliel-basic', '', '', '{"type":"text"}']);
        ...
        $this->insertDefaultRow(['board', 'nelliel', 'boolean', 'display_render_timer', '', '1', '', '', '{"type":"checkbox"}']);
        ...
        $this->insertDefaultRow(['board', 'nelliel', 'boolean', 'generate_catalog', '', '1', '', '', '{"type":"checkbox"}']);
