...
class TableSettings extends TableHandler
{
    ...
    public function insertDefaults()
    {
        ...
        $this->insertDefaultRow(['board', 'nelliel', 'integer', 'max_files_row', '', '3', 'Number of files to display in each row', '', '{"type":"number"}']);
        ...
        $this->insertDefaultRow(['board', 'nelliel', 'string', 'preferred_filename', '', 'original', 'Preferred filename for uploads', '', '{"type":"text"}']);
        ...
        $this->insertDefaultRow(['board', 'nelliel', 'boolean', 'filter_combining_characters', '', '0', 'Filter Unicode combining characters', 'Combining characters are sometimes misused for things like Zalgo text).
				WARNING: This can break a bunch of non-English languages!', '{"type":"checkbox"}']);
