...
class TableUploads extends Table
{
    ...
    function __construct($database, $sql_compatibility)
    {
        ...
        $this->column_types = [
            ...
            'md5' => ['php_type' => 'string', 'pdo_type' => PDO::PARAM_LOB],
            'sha1' => ['php_type' => 'string', 'pdo_type' => PDO::PARAM_LOB],
            'sha256' => ['php_type' => 'string', 'pdo_type' => PDO::PARAM_LOB],
            'sha512' => ['php_type' => 'string', 'pdo_type' => PDO::PARAM_LOB],
