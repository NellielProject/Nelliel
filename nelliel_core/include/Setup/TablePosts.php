...
class TablePosts extends Table
{
    ...
    function __construct($database, $sql_compatibility)
    {
        ...
        $this->column_types = [
            ...
            'has_uploads' => ['php_type' => 'boolean', 'pdo_type' => PDO::PARAM_INT],
            ...
            'content_hash' => ['php_type' => 'string', 'pdo_type' => PDO::PARAM_LOB],
        ...
        $this->column_checks = [
            ...
            'has_uploads' => ['row_check' => false, 'auto_inc' => false],
    ...
    public function buildSchema(array $other_tables = null)
    {
        ...
        CREATE TABLE " . $this->table_name . " (
            ...
            has_uploads         SMALLINT NOT NULL DEFAULT 0,
