...
class TableFiletypes extends Table
{
    ...
    public function insertDefaults()
    {
        ...
        $this->insertDefaultRow(['mkv', 'video', 'mkv', 'video/x-matroska', '[]', '^\x1A\x45\xDF\xA3', 'Matroska Video', 0, 1]);
        ...
        $this->insertDefaultRow(['docx', 'document', 'open-msword', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', '[]', '^PK\x03\x04', 'MS Open XML Word', 0, 1]);
        $this->insertDefaultRow(['ppt', 'document', 'powerpoint', 'application/ms-powerpoint', '[]', '^\xD0\xCF\x11\xE0\xA1\xB1\x1A\xE1', 'PowerPoint', 0, 1]);
        $this->insertDefaultRow(['pptx', 'document', 'open-powerpoint', 'application/vnd.openxmlformats-officedocument.presentationml.document', '[]', '^PK\x03\x04', 'MS Open XML Presentation', 0, 1]);
        $this->insertDefaultRow(['xls', 'document', 'msexcel', 'application/ms-excel', '[]', '^\xD0\xCF\x11\xE0\xA1\xB1\x1A\xE1', 'Microsoft Excel', 0, 1]);
        $this->insertDefaultRow(['xlsx', 'document', 'open-msexcel', 'application/vnd.openxmlformats-officedocument.spreadsheetml.document', '[]', '^PK\x03\x04', 'MS Open XML Spreadsheet', 0, 1]);
        $this->insertDefaultRow(['txt', 'document', 'plaintext', 'text/plain', '[]', '', 'Plaintext', 0, 1]);
        ...
        $this->insertDefaultRow(['7z', 'archive', '7zip', 'application/x-7z-compressed', '[]', '^\x37\x7A\xBC\xAF\x27\x1C', '7z', 0, 1]);
