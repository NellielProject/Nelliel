...
class OutputPanelMain extends Output
{
    ...
    public function render(array $parameters, bool $data_only)
    {
        ...
        $user_roles = $this->database->executePreparedFetchAll($prepared, [$this->session->sessionUser()->id()],
                PDO::FETCH_ASSOC);
        ...
        $this->render_data['module_users'] = $this->session->sessionUser()->checkPermission($this->domain,
                'perm_manage_users');
        $this->render_data['users_url'] = NEL_MAIN_SCRIPT_QUERY_WEB_PATH . 'module=admin&section=users';
        $this->render_data['module_roles'] = $this->session->sessionUser()->checkPermission($this->domain,
                'perm_manage_roles');
        ...
        $this->render_data['module_styles'] = $this->session->sessionUser()->checkPermission($this->domain,
                'perm_manage_styles');
        ...
        $this->render_data['module_news'] = $this->session->sessionUser()->checkPermission($this->domain,
                'perm_manage_news');
        ...
        $this->render_data['regen_site_caches'] = $this->session->sessionUser()->checkPermission($this->domain,
                'perm_regen_cache');
