...
class OutputPanelBoard extends Output
{
    ...
    public function render(array $parameters, bool $data_only)
    {
        ...
        $this->render_data['module_modmode'] = $this->session_user->checkPermission($this->domain, 'perm_board_mod_mode');
        ...
        $this->render_data['regen_board_pages'] = $this->session_user->checkPermission($this->domain, 'perm_regen_pages');
        $this->render_data['regen_pages_url'] = NEL_MAIN_SCRIPT_QUERY_WEB_PATH .
                'module=regen&actions=board-all-pages&board-id=' . $board_id;
        $this->render_data['regen_board_caches'] = $this->session_user->checkPermission($this->domain,
                'perm_regen_cache');
