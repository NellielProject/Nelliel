...
class TableRolePermissions extends Table
{
    ...
    public function insertDefaults()
    {
        ...
        $this->insertDefaultRow(['SITE_ADMIN', 'perm_icon_sets_manage', 1]);
        ...
        $this->insertDefaultRow(['SITE_ADMIN', 'perm_notice_board_view', 1]);
        $this->insertDefaultRow(['SITE_ADMIN', 'perm_notice_board_post', 1]);
        $this->insertDefaultRow(['SITE_ADMIN', 'perm_notice_board_delete', 1]);
        ...
        $this->insertDefaultRow(['BOARD_OWNER', 'perm_icon_sets_manage', 0]);
        ...
        $this->insertDefaultRow(['BOARD_OWNER', 'perm_notice_board_view', 1]);
        $this->insertDefaultRow(['BOARD_OWNER', 'perm_notice_board_post', 1]);
        $this->insertDefaultRow(['BOARD_OWNER', 'perm_notice_board_delete', 0]);
        ...
        $this->insertDefaultRow(['MODERATOR', 'perm_icon_sets_manage', 0]);
        ...
        $this->insertDefaultRow(['MODERATOR', 'perm_notice_board_view', 1]);
        $this->insertDefaultRow(['MODERATOR', 'perm_notice_board_post', 1]);
        $this->insertDefaultRow(['MODERATOR', 'perm_notice_board_delete', 0]);
        ...
        $this->insertDefaultRow(['JANITOR', 'perm_icon_sets_manage', 0]);
        ...
        $this->insertDefaultRow(['JANITOR', 'perm_notice_board_view', 1]);
        $this->insertDefaultRow(['JANITOR', 'perm_notice_board_post', 0]);
        $this->insertDefaultRow(['JANITOR', 'perm_notice_board_delete', 0]);
        ...
        $this->insertDefaultRow(['BASIC_USER', 'perm_icon_sets_manage', 0]);
        ...
        $this->insertDefaultRow(['BASIC_USER', 'perm_notice_board_view', 0]);
        $this->insertDefaultRow(['BASIC_USER', 'perm_notice_board_post', 0]);
        $this->insertDefaultRow(['BASIC_USER', 'perm_notice_board_delete', 0]);
