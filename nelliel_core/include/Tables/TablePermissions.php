...
class TablePermissions extends Table
{
    ...
    {
        $this->insertDefaultRow(['perm_access_bans', 'Access the bans panel']);
        $this->insertDefaultRow(['perm_manage_bans', 'Manage bans']);
        $this->insertDefaultRow(['perm_access_boards', 'Access the boards panel']);
        ...
        $this->insertDefaultRow(['perm_manage_blotter', 'Manage blotter']);
        ...
        $this->insertDefaultRow(['perm_access_logs', 'Access the logs panel']);
        ...
        $this->insertDefaultRow(['perm_access_roles', 'Access the roles panel']);
        ...
        $this->insertDefaultRow(['perm_access_wordfilters', 'Access the wordfilters panel']);
