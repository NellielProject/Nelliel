...
class TablePermissions extends Table
{
    ...
    public function insertDefaults()
    {
        ...
        $this->insertDefaultRow(['perm_dnsbl_manage', 'Manage DNSBL entries.']);
        ...
        $this->insertDefaultRow(['perm_icon_sets_manage', 'Manage icon sets.']);
        ...
        $this->insertDefaultRow(['perm_notice_board_view', 'View the staff noticeboard']);
        $this->insertDefaultRow(['perm_notice_board_post', 'Post on the staff noticeboard']);
        $this->insertDefaultRow(['perm_notice_board_delete', 'Delete posts on the staff noticeboard']);
