...
class OutputPanelManageBoards extends OutputCore
{
    ...
    private function panel(array $parameters, bool $data_only)
    {
        ...
        $this->render_data['form_action'] = NEL_MAIN_SCRIPT . '?module=manage-boards&action=add&domain=_site_';
        ...
        foreach ($board_data as $board_info)
        {
            ...
            if ($board_info['locked'] == 0)
            {
                $board_data['lock_url'] = $this->url_constructor->dynamic(NEL_MAIN_SCRIPT,
                        ['module' => 'manage-boards', 'board_id' => $board_info['board_id'], 'action' => 'lock', 'domain_id' => '_site_']);
            ...
            {
                $board_data['lock_url'] = $this->url_constructor->dynamic(NEL_MAIN_SCRIPT,
                        ['module' => 'manage-boards', 'board_id' => $board_info['board_id'], 'action' => 'unlock', 'domain_id' => '_site_']);
            ...
            $board_data['remove_url'] = $this->url_constructor->dynamic(NEL_MAIN_SCRIPT,
                    ['module' => 'manage-boards', 'board_id' => $board_info['board_id'], 'action' => 'remove', 'domain_id' => '_site_']);
