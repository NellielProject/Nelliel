...
class OutputRegisterPage extends Output
{
    ...
    private function registrationPage(array $parameters, bool $data_only)
    {
        ...
        $this->render_data['use_register_captcha'] = nel_site_domain()->setting('enable_captchas') && $this->domain->setting('use_register_captcha');
        ...
        $this->render_data['use_register_recaptcha'] = nel_site_domain()->setting('enable_captchas') && $this->domain->setting('use_register_recaptcha');
