...
class OutputPanelScripts extends Output
{
    ...
    public function main(array $parameters, bool $data_only)
    {
        ...
        $this->render_data['new_url'] = nel_build_router_url([$this->domain->uri(), 'scripts', 'new']);
    ...
    public function edit(array $parameters, bool $data_only)
    {
        ...
        if ($editing) {
            ...
            $form_action = nel_build_router_url([$this->domain->uri(), 'scripts', $script_id, 'modify']);
            ...
            $form_action = nel_build_router_url([$this->domain->uri(), 'scripts', 'new']);
        }
