...
class TableSettingOptions extends Table
{
    ...
    public function insertDefaults()
    {
        ...
        $this->insertDefaultRow(['board', 'preferred_filename', '{"Filtered original": "filtered_original", "Unix timestamp": "timestamp", "MD5": "md5", "SHA1": "sha1", "SHA256": "sha256", "SHA512": "sha2512"}', 0, 0]);
        ...
        $this->insertDefaultRow(['site', 'site_nav_links_right_bracket', '', 1, 0]);
        $this->insertDefaultRow(['site', 'site_nav_links_home', '', 1, 0]);
        $this->insertDefaultRow(['site', 'site_nav_links_news', '', 1, 0]);
        $this->insertDefaultRow(['site', 'site_nav_links_faq', '', 1, 0]);
        $this->insertDefaultRow(['site', 'site_nav_links_about_nelliel', '', 1, 0]);
        $this->insertDefaultRow(['site', 'site_nav_links_blank_page', '', 1, 0]);
        $this->insertDefaultRow(['site', 'account_nav_links_left_bracket', '', 1, 0]);
        $this->insertDefaultRow(['site', 'account_nav_links_right_bracket', '', 1, 0]);
        $this->insertDefaultRow(['site', 'account_nav_links_account', '', 1, 0]);
        $this->insertDefaultRow(['site', 'account_nav_links_site_panel', '', 1, 0]);
        $this->insertDefaultRow(['site', 'account_nav_links_global_panel', '', 1, 0]);
        $this->insertDefaultRow(['site', 'account_nav_links_board_panel', '', 1, 0]);
        $this->insertDefaultRow(['site', 'account_nav_links_board_list', '', 1, 0]);
        $this->insertDefaultRow(['site', 'account_nav_links_logout', '', 1, 0]);
