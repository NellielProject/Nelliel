    ...
    protected function write(array $record): void
    {
        if ($record['channel'] === 'system') {
            $prepared = $this->database->prepare(
                ...
                '" ("level", "event", "message", "message_values", "time", "domain_id", "username", "unhashed_ip_address", "hashed_ip_address", "visitor_id", "moar")
								VALUES (:level, :event, :message, :message_values, :time, :domain_id, :username, :unhashed_ip_address, :hashed_ip_address, :visitor_id, :moar)');
        }
        ...
        $prepared->bindValue(':unhashed_ip_address', $record['extra']['ip_address'], PDO::PARAM_STR);
